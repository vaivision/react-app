...
export default class CallScriptDepre7 extends Component
{
  componentDidMount()
  {
    const url = 'https://kt1bojna1d.execute-api.us-west-2.amazonaws.com/dev/survey?u=1157&sk=call7&a=history'
...
render(){
  ...
  return (
    <div>
      ...
      <a href={"/callScriptDepre7?name="+name}   className="button is-light">Depression Call 7</a>
      </center>
		  </p>
