...
export default class DepressionCall5 extends Component
{
  componentDidMount()
  {
    const url = 'https://kt1bojna1d.execute-api.us-west-2.amazonaws.com/dev/survey?u=1157&sk=call5'
...
render(){
  ...
  return (
    <div>
      ...
      <a href={"/depressionCall5?name="+name}   className="button is-light">Depression Call 5</a>&emsp;
