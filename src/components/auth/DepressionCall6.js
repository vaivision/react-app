...
export default class DepressionCall6 extends Component
{
  componentDidMount()
  {
    const url = 'https://kt1bojna1d.execute-api.us-west-2.amazonaws.com/dev/survey?u=1157&sk=call6'
...
render(){
  ...
  return (
    <div>
      ...
      <a href={"/depressionCall6?name="+name}   className="button is-light">Depression Call 6</a>&emsp;
