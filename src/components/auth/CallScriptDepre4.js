...
export default class CallScriptDepre4 extends Component
{
  componentDidMount()
  {
    const url = 'https://kt1bojna1d.execute-api.us-west-2.amazonaws.com/dev/survey?u=1157&sk=call4&a=history'
...
render(){
  ...
  return (
    <div>
      ...
      <a href={"/callScriptDepre4?name="+name}   className="button is-light">Depression Call 4</a>&emsp;
