...
export default class CallScriptDepre5 extends Component
{
  componentDidMount()
  {
    const url = 'https://kt1bojna1d.execute-api.us-west-2.amazonaws.com/dev/survey?u=1157&sk=call5&a=history'
...
render(){
  ...
  return (
    <div>
      ...
      <a href={"/callScriptDepre5?name="+name}   className="button is-light">Depression Call 5</a>&emsp;
